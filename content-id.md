...
**Confidence Weighted Lead Lag (CWLL)**:
...
| :--- | :--- | :--- | :--- |
| **Laju Belajar ($\alpha_t$)** | $\alpha_t = \alpha_{\min} + (\alpha_{\max}-\alpha_{\min}) (1-z_t)^{p_{\alpha}}$ | $\alpha_t = \alpha_{\min} + (\alpha_0 - \alpha_{\min}) \left(1 - \frac{t}{T}\right)$ | Penyerapan informasi dinamis vs peluruhan linier non-adaptif |
...
| **Eksplorasi ($\epsilon_t$)** | $\epsilon_t = \epsilon_{\min} + (\epsilon_{\max}-\epsilon_{\min})(1-z_t)^{3{,}0}$ | $\epsilon_t = \epsilon_{\min} + (\epsilon_0 - \epsilon_{\min}) \left(1 - \frac{t}{T}\right)$ | Eksplorasi sensitif kemahiran (*power scaling*) vs peluruhan linier |
...
<div class="trajectory-container" style="display: flex; gap: 20px; justify-content: center;">
  <img src="./assets/adversarial_inactive_reward/learning_curve_steps.png" width="30%">
  <img src="../assets/adversarial_inactive_reward/bar_metrics.png" width="60%">
...
| **Komunikasi**   | Natural LLM     | Natural LLM     | Kaku           | Natural LLM |
...
<!-- top-title: Kesimpulan Utama -->
<!-- bottom-title: Kelemahan Penelitian -->
<!-- part-3-title: Rekomendasi Penelitian -->
<!-- section: Penutup -->
